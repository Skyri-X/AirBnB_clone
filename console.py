    ...
    def do_create(self, args):
        ...
        if args:
            ...
            for item in args:
                ...
                param = param[2]
                # extract value if it's a string
                if att_name and param[0] == '\"':
                    second_quote = param.find('\"', 1)
                    att_val = param[1:second_quote].replace("_", " ")

                # if it's an int or float
                elif not att_val and param:
                    att_val = eval(param)
